        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-xl">
          ...
          <div className="flex gap-4 pt-6">
            <button
              ...
              className="flex-1 flex justify-center rounded-md px-3 py-2 text-sm font-semibold text-white bg-rose-400 hover:bg-rose-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-600 disabled:opacity-50 disabled:cursor-not-allowed"
            >
