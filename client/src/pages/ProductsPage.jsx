        ...
        <div className="text-center">
          ...
          {isAdmin && (
            <button
              ...
              className="mt-4 inline-flex items-center rounded-md px-4 py-2 text-sm font-semibold text-white bg-rose-400 hover:bg-rose-600"
            >
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <div className="flex justify-between items-center mb-8">
          ...
          {isAdmin && (
            <button
              onClick={handleCreateClick}
              className="inline-flex items-center rounded-md px-4 py-2 text-sm font-semibold text-white bg-rose-400 hover:bg-rose-600"
            >
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
              </svg>
            ...
            <div key={product.product_id} className="group relative">
              ...
              <div className="mt-4 flex justify-between">
                ...
                <button
                  ...
                  className="relative z-20 w-full mt-2 inline-flex items-center justify-center rounded-md px-3 py-1 text-sm font-semibold text-white bg-rose-400 hover:bg-rose-600"
                >
                  Add to Cart
                </button>
            </div>
