        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-md bg-rose-400 px-3 py-1.5 text-sm/6 font-semibold text-white hover:bg-rose-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500"
              >
                Sign in
              </button>
            </div>
          ...
          <p className="mt-10 text-center text-sm/6 text-gray-600">
            ...
            <Link to="/register" className="font-semibold text-rose-600 hover:text-rose-400">
              Register
            </Link>
          </p>
        </div>
